    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Vartika</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Vartika's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">— Comrade</h2>
          <p className="final-subtitle">Always keep smiling ✨</p>
        </section>
      </div>
